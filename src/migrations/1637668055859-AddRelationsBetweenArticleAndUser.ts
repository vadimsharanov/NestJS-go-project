...
export class AddRelationsBetweenArticleAndUser1637668055859 implements MigrationInterface {
	name = "AddRelationsBetweenArticleAndUser1637668055859";
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`COMMENT ON COLUMN "users"."bio" IS NULL`);
